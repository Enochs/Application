...
namespace HA.PMS.ToolsLibrary
{
    public static class CustomExtensions
    {
        ...
        public static void Add(this System.Collections.Generic.List<System.Data.Objects.ObjectParameter> list, bool condition, string name, params object[] value)
        {
            if (condition)
            {
                list.Add(new System.Data.Objects.ObjectParameter(name, value.Length > 1 ? string.Join(",", value) : value[0]));
            }
        }
        ...
        /// <param name="name">参数名。</param>
        /// <param name="value">参数的初始值数组。</param>
        public static void Add(this System.Collections.Generic.List<System.Data.Objects.ObjectParameter> list, string name, params object[] value)
        {
            list.Add(new System.Data.Objects.ObjectParameter(name, value.Length > 1 ? string.Join(",", value) : value[0]));
        }
