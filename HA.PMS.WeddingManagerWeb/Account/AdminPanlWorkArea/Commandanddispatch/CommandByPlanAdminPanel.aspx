<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="CommandByPlanAdminPanel.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Commandanddispatch.CommandByPlanAdminPanel" %>
        ...
        <div class="widget-box">
            <div class="widget-title">
                <ul class="nav nav-tabs">
                    <li onclick="Settabs(this,'/AdminPanlWorkArea/Commandanddispatch/GeneralManagerPodium/WorkCheckGuide.aspx?NeedPopu=1');" class="HAtab"  id="DefaultTab"><a data-toggle="tab" href="#111" >工作指导检查</a></li>
                    ...
                    <li class="HAtab"  style="display: none;"><a data-toggle="tab" href="#111" onclick="Settabs('#tab3',3,'/AdminPanlWorkArea/Commandanddispatch/CommandByPlanEmployeeManager.aspx?NeedPopu=1');">下属指标动态</a></li>
                    ...
                    <li class="HAtab"  onclick="Settabs(this,'/AdminPanlWorkArea/QuotedPrice/QuotedPriceallList.aspx?NeedPopu=1');"><a data-toggle="tab" href="#111">订单明细</a></li>
