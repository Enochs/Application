<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="CommandByMoneyAdminPanel.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Commandanddispatch.CommandByMoneyAdminPanel" %>
        ...
        <div class="widget-box">
            <div class="widget-title">
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#111" onclick="Settabs('#tab4',4,'/AdminPanlWorkArea/Commandanddispatch/CommandByMoneyManager.aspx?NeedPopu=1');">财务指标统计</a></li>
                    <li><a data-toggle="tab" href="#111" onclick="Settabs('#tab5',5,'/AdminPanlWorkArea/Foundation/FDTelemarketing/FD_TelemarketingCustomersDetails.aspx?NeedPopu=1');">定金明细</a></li>
                    <li class="HAtab"  id="Li2" onclick="Settabs(this,'/AdminPanlWorkArea/Carrytask/CarrytaskOfMonth.aspx');"><a data-toggle="tab" href="#111">当月订单</a></li>
                    <li><a data-toggle="tab" href="#111" onclick="Settabs('#tab6',6,'');">收款明细</a></li>
                    <li class="HAtab"  id="Li1" onclick="Settabs(this,'/AdminPanlWorkArea/Carrytask/CarrytaskOfMonth.aspx?NeedPopu=1');"><a data-toggle="tab" href="#111">当月订单</a></li>
