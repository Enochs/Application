<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="CommandByExecuteManager.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Commandanddispatch.CommandByExecuteManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="widget-box">
        <div class="widget-content">
            ...
            <HA:MessageBoardforEmpLoyee runat="server" ID="MessageBoardforall" />
        </div>
    </div>
</asp:Content>
