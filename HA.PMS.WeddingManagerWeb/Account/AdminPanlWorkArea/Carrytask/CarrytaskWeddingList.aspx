                    ...
                    <asp:Repeater ID="repCustomer" runat="server" OnItemCommand="repCustomer_ItemCommand">
                        <ItemTemplate>
                            <tr skey='<%#Eval("CustomerID") %>' <%#Eval("DesignerState").ToString().ToInt32() == 1 ? "style='color:red'" : "" %>>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtPlanDate" onclick="WdatePicker();" Width="80px" Text='<%#string.Format("{0:yyyy-MM-dd}",Eval("PlanFinishDate")) %>' />
                                </td>
                                <td><%#string.Format("{0:yyyy-MM-dd}",Eval("AutualFinishDate")) %></td>
                                <td id="Partd<%#Container.ItemIndex %>">
                                    <input runat="server" style="margin: 0; width: 60px;" id="txtEmployee" class="txtEmpLoyeeName" type="text" value='<%#GetEmployeeName(Eval("EarlyEmployee")) %>' onclick="ShowPopu(this);" />
                                ...
                                <td>
                                    <input runat="server" style="margin: 0; width: 60px;" id="txtEmpLoyee1" class="txtEmpLoyeeName1" type="text" value='<%#GetEmployeeName(Eval("DesignerEmployee")) %>' readonly="true" />
                                    <a href="#" onclick="ShowPopu(this);" class="SetState btn btn-primary" style="display: none">分派</a>
                                ...
                                <td>
                                    ...
                                    <a target="_blank" href=" /AdminPanlWorkArea/QuotedPrice/QuotedPriceShow.aspx?QuotedID=<%#GetQuotedID(Eval("OrderID")) %>&OrderID=<%#Eval("OrderID") %>&CustomerID=<%#Eval("CustomerID") %>" class="btn btn-primary  btn-mini">报价单</a>
