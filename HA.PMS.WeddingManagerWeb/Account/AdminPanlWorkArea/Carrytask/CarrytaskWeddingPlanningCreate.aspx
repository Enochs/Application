<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarrytaskWeddingPlanningCreate.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Carrytask.CarrytaskWeddingPlanningCreate" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" %>
    ...
    <div style="overflow-x: auto; width: 1200px;">
        <table id="tblContent" style="text-align: center; width: 100%;" border="1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <asp:Repeater ID="repWeddingPlanning" runat="server" OnItemCommand="repWeddingPlanning_ItemCommand" OnItemDataBound="repWeddingPlanning_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="white-space: nowrap;">
                                <label <%#Eval("State")!=null?"style='display:none;'":"" %> >
                                ...
                                <asp:LinkButton ID="lnkbtnSaveEdit" CssClass="btn btn-success" CommandName="Edit" CommandArgument='<%#Eval("PlanningID") %>' runat="server">确认完成</asp:LinkButton>
                                    </label>
                            </td>
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan="9"><asp:Button runat="server" ID="btnExport" Text="导出" CssClass="btn btn-primary" OnClick="btnExport_Click" /></td>
                </tr>
            </tfoot>
        </table>
    </div>
