    ...
    public partial class Notassignedtsks : SystemPage
    {
        ...
        public void SpliteAll()
        {
            ...
            if (level.Count == 0)
            {
                ...
                Response.Redirect("/AdminPanlWorkArea/Carrytask/CarrytaskWork/TaskWorkPanel.aspx?PageNameProductList&DispatchingID=" + DispatchingID + "&CustomerID=" + CustomerID + "&NeedPopu=1&PageName=ProductList");
            }
            else
            {
