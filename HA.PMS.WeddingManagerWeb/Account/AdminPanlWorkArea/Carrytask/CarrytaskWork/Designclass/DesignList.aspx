            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <asp:Repeater ID="repCustomer" runat="server">
                        <ItemTemplate>
                            <tr skey='QuotedPriceQuotedID<%#Eval("QuotedID") %>' <%#ChangeForColor(Eval("DesignerState")) %>>
                                ...
                                <td id="Partd<%#Container.ItemIndex %>">
                                    ...
                                    <a href="#" onclick="ShowPopu(this);" class="SetState btn btn-primary btnSaveSubmit4 btnSumbmit">分派</a>
