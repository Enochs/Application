    ...
    public partial class CarrytaskList : SystemPage
    {
        ...
        protected void BindData(object sender, EventArgs e)
        {
            ...
            if (QueryDateRanger.IsNotBothEmpty)
            {
                ...
                {
                    objParmList.Add("OrderCreateDate", QueryDateRanger.StartoEnd, NSqlTypes.DateBetween);
            ...
            {
                MyManager.GetEmployeePar(objParmList, "OrderEmployee");
            }
        ...
        {
            if (source != null && source.ToString().ToInt32() != 0 && source1 != null && source1.ToString().ToInt32() != 0)
            {
                decimal TotalCost = GetCostByCustomerID(source).ToDecimal();        //总成本
                decimal SalePrice = GetFinishAmount(source1).ToDecimal();           //销售额
                if (SalePrice > 0)
                {
