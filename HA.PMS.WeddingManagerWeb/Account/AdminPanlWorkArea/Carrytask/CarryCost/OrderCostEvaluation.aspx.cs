...
namespace HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Carrytask.CarryCost
{
    public partial class OrderCostEvaluation : System.Web.UI.Page
    {
        ...
        protected void btnSavePri_Click(object sender, EventArgs e)
        {
            ...
            BinderData();
            JavaScriptTools.AlertWindowAndLocation("修改成功!", "OrderCost.aspx?DispatchingID=" + DispatchingID + "&CustomerID=" + CustomerID + "&Type=Details&NeedPopu=1", Page);
        ...
        public void UpdateDesign(Repeater rptItem)
        {
            for (int i = 0; i < rptItem.Items.Count; i++)
            {
                ...
                FL_Designclass DesignModel = ObjDesignBLL.GetByID(DesignClassId.ToString().ToInt32());
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            //操作日志
            CreateHandle();
            JavaScriptTools.AlertWindowAndLocation("确认提交成功!", Request.Url.ToString(), Page);
        }
        #endregion
        ...
        {
            //DropDownList ddlEvalution = e.Item.FindControl("ddlEvaluation") as DropDownList;
            //if (ddlEvalution.SelectedValue.ToInt32() < 6)
            //{
            //    ddlEvalution.Enabled = false;
            //}
        }
        #endregion
