<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" CodeBehind="CustomerActives.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.CustomerProject.JinseBainian.CustomerActives" %>
                        ...
                        <asp:Repeater ID="repColn" runat="server" OnItemDataBound="repColn_ItemDataBound">
                            <ItemTemplate>
                                <td style="text-align: center;">
                                    ...
                                    <label style="color:red;cursor:default;">
                                    <br />
                                    ...
                                    <asp:Label ID="lblItem1" Font-Bold="true" runat="server" Width="30" Height="30" BackColor="Snow" Text="午宴" onclick="ShowReport(this,'午宴');" style="cursor:pointer;"></asp:Label>
                                 
                                    <asp:Label ID="lblItem2" Font-Bold="true" runat="server" Width="30" Height="30" BackColor="Snow" Text="晚宴" onclick="ShowReport(this,'晚宴');" style="cursor:pointer;"></asp:Label>
