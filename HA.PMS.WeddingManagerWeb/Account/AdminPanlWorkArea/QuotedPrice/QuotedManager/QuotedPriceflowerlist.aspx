<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotedPriceflowerlist.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.QuotedPrice.QuotedManager.QuotedPriceflowerlist" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" %>
                    ...
                    <asp:Repeater ID="repCustomer" runat="server">
                        <ItemTemplate>
                            <tr skey='QuotedPriceQuotedID<%#Eval("QuotedID") %>'>
                                ...
                                <td><%#GetState(Eval("QuotedID"))%></td>
                                <td id="tbOper">

 
                                    <a class="btn btn-primary btn-mini" href="QuotedPriceFlowerItemEdit.aspx?OrderID=<%#Eval("OrderID") %>&QuotedID=<%#Eval("QuotedID") %>&CustomerID=<%#Eval("CustomerID") %>&<%#Request["Typer"] %>=1">花艺核价</a>
