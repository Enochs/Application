<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotedPriceLossCheck.aspx.cs"  MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.QuotedPrice.QuotedManager.QuotedPriceLossCheck" %>
                        ...
                        <ItemTemplate>
                            <tr skey='QuotedPriceQuotedID<%#Eval("QuotedID") %>'>
                                ...
                                <td id="tbOper">
                                    ...
                                    <a class="btn btn-primary btn-mini" href="../QuotedPriceShow.aspx?OrderID=<%#Eval("OrderID") %>&QuotedID=<%#Eval("QuotedID") %>&CustomerID=<%#Eval("CustomerID") %>&Delete=1&Check=1" >报废审核</a>
