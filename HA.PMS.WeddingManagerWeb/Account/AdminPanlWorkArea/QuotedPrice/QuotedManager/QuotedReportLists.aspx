<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotedReportLists.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.QuotedPrice.QuotedManager.QuotedReports" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" %>
                    ...
                    <asp:Repeater ID="repCustomer" runat="server">
                        <ItemTemplate>
                            <tr skey='QuotedPriceQuotedID<%#Eval("QuotedID") %>'>
                                ...
                                <td id="tbOper">
                                    <a class="btn btn-primary btn-mini" href="QuotedPriceFlowerItemEdit.aspx?OrderID=<%#Eval("OrderID") %>&QuotedID=<%#Eval("QuotedID") %>&CustomerID=<%#Eval("CustomerID") %>&<%#Request["Typer"] %>=1">查看花艺核价单</a>
