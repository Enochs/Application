                    ...
                    <asp:Repeater ID="repCustomer" runat="server">
                        <ItemTemplate>
                            <tr skey='QuotedPriceQuotedID<%#Eval("QuotedID") %>'>
                                ...
                                <td>
                                    <a class="btn btn-primary btnSaveSubmit<%#Eval("EmployeeID") %> btnSumbmit" href="QuotedPriceDispatchingUpdate.aspx?OrderID=<%#Eval("OrderID") %>&QuotedID=<%#Eval("QuotedID") %>&CustomerID=<%#Eval("CustomerID") %>&Type=Dispatching&QuotedEmployee=<%#Eval("EmployeeID") %>" target="_blank">派工</a>
