<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotedPriceShow.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.QuotedPrice.QuotedPriceShow" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1">
    <input id="Button1" style="margin: 0; margin-bottom: 5px" type="button" value="退出预览" class="btn btn-info" onclick="CloseWindown();" />
    <input id="btnPrint" type="button" value="打印报价单" class="btn" style="display: none;" />
    <a href="#" id="SelectEmpLoyeeBythis" style="display: none;">上传图片</a><asp:Label ID="lblLoseNode" runat="server" Text="报废原因"></asp:Label>
    <asp:TextBox ID="txtLostNode" runat="server" Height="52px" TextMode="MultiLine" Width="788px"></asp:TextBox>
    &nbsp;<asp:Button ID="btnloss" runat="server" Text="确认报废" class="btn" OnClick="btnloss_Click" />
    <asp:Button ID="btnreturn" runat="server" Text="打回" class="btn" OnClick="btnreturn_Click" Visible="false" />
    ...
    <div id="PrintNode">
        ...
        <asp:Repeater ID="repfirst" runat="server" OnItemDataBound="repfirst_ItemDataBound">
            <ItemTemplate>
                <table class="table table-bordered table-striped First<%#Eval("CategoryID") %>">
                    ...
                    <tr>
                        <td colspan="9" style="text-align: right; padding-right: 2em">分项合计：<%#Eval("ItemAmount")%></td>
                    </tr>
                </table>
            </ItemTemplate>
        </asp:Repeater>
        <table class="table table-bordered table-striped">
            <tr>
                <td width="120px">销售总价</td>
                <td width="120px">
                    <asp:Label ID="txtRealAmount" runat="server" ClientIDMode="Static"></asp:Label></td>
                <td colspan="7"></td>
            </tr>
        </table>
        <div>
