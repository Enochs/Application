<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="MyComplain.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Flows.Mission.MyComplain" %>
                    ...
                    <asp:Repeater ID="rptComplain" runat="server" OnItemCommand="rptComplain_ItemCommand">
                        ...
                        <ItemTemplate>
                            ...
                            <tr>
                                ...
                                <td><%#GetDateStr( Eval("PartyDate")) %></td>
                                <td><%#Eval("Wineshop") %></td>
                                ...
                                <td>
                                    ...
                                    <a href="/AdminPanlWorkArea/CS/CS_ComplainCreate.aspx?ComplainID=<%#Eval("ComplainID") %>" class="btn btn-primary  btn-mini" <%#Eval("ComplainEmployeeId").ToString()==User.Identity.Name?"":"style='display:none;'" %>>处理投诉</a>
