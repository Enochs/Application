<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FL_MissioninWait.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Flows.Mission.FL_MissioninWait" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="widget-box">
        ...
        <div class="widget-content">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="white-space: nowrap;">
                            ...
                            <a class="btn btn-primary btn-mini" href="FL_MissionChangeApply.aspx?DetailedID=<%#Eval("DetailedID") %>" <%#IsManager(Eval("EmployeeID")) %>>申请变更</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
            ...
            <cc1:AspNetPagerTool ID="CtrPageIndex" runat="server" OnPageChanged="CtrPageIndex_PageChanged" PageSize="15"></cc1:AspNetPagerTool>
