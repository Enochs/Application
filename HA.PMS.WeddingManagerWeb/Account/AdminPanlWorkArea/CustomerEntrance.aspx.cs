    ...
    public partial class CustomerEntrance : SystemPage
    {
        ...
        protected void btnSaveChange_Click(object sender, EventArgs e)
        {
            ...
            if (txtCustomerPhone.Text != string.Empty)
            {
                ...
                var SerchList = ObjCustomersBLL.GetDataByWhereParameter(ObjParList, OrderByColumnName, 10, 1, out SoutceCounts);
                if (SerchList != null)
                {
                    SerchList.State = (int)CustomerStates.BeginFollowOrder;
                    ObjCustomersBLL.Update(SerchList);
                    var ObjOrderModel = ObjCustomersBLL.GetByID(SerchList.CustomerID);
                ...
                else
                {
                    ...
                    //{
                    //    if (ddlChannelName2.SelectedItem.Text == "手动录入")
                    //    {
                    //        fl_Coustomers.Referee = txtRef.Value;
                    //    }
                    //    else
                    //    {
                    //        fl_Coustomers.Referee = ddlReferee1.SelectedItem.Value.ToInt32() <= 0 ? "" : ddlReferee1.SelectedItem.Text;
                    //    }
                    //}
                    //if (ddlChannelName2.SelectedItem.Text == "手动录入")
                    //{
