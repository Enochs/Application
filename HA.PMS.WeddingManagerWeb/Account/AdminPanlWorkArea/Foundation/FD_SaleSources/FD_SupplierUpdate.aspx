...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        $(window).load(function () {
            ...
            BindTel('<%=txtTelPhone.ClientID%>:<%=txtAccount.ClientID%>');
        ...
        <div class="widget-content">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <td>Email</td>
                    <td>
                        <asp:TextBox ID="txtEmail" MaxLength="20" check="0" CssClass="{required:true,email:true}"  runat="server"></asp:TextBox>
                    </td>
                    <td>座机</td>
                    <td>
                        <asp:TextBox ID="txtTelPhone" MaxLength="20" check="0" CssClass="{required:true}" runat="server"></asp:TextBox>
                    </td>
                    <td>账户信息</td>
                    <td>
                        <asp:TextBox ID="txtAccount" MaxLength="20" check="0" CssClass="{required:true}" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>产品类别</td>
