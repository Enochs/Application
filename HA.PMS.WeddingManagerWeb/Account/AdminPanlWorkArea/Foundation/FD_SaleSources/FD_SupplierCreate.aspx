...
<span style="color:red">*</span>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtAccount"  check="0" CssClass="{required:true}" runat="server" MaxLength="20"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink ID="hlCreateProduct" Visible="false" CssClass="btn btn-primary  btn-mini"
                         runat="server">为该供应商添加产品</asp:HyperLink> </td>
                    <td></td>
                    <td></td>
                    <td></td>
                </tr>
