<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" AutoEventWireup="true" CodeBehind="FD_HotelUpdate.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Foundation.FD_Hotel.FD_HotelUpdate" %>
        ...
        <div class="widget-content">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <ul>
                            <asp:Repeater ID="rptLabelList" OnItemDataBound="rptLabelList_ItemDataBound" runat="server">
                                <ItemTemplate>
