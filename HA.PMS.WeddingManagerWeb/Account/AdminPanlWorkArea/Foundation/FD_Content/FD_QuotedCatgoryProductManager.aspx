...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function ShowUpdateWindows(KeyID, Control) {
            ...
            Url= "FD_QuotedCatgoryProductCreateUpdate.aspx?SourceProductId=" + KeyID + "&PageIndex="+<%=StorePager.CurrentPageIndex%>;
            ...
            <table class="table table-bordered table-select">
                <thead>
                    <tr>
                        ...
                        <th>项目<asp:DropDownList ID="ddlSecondCatgory" runat="server"></asp:DropDownList>
                            <br />
                        </th>
                        ...
                        <th colspan="6" style="text-align: left; vertical-align: middle;">
                            <a href="#" id="ACreateProduct" class="btn   btn-mini" onclick="ShowUpdateWindows('',this);">添加产品</a>
                        </th>
                    </tr>
                    <tr>
