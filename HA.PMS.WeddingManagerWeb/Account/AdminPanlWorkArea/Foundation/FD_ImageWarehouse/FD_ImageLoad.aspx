<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FD_ImageLoad.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Foundation.FD_ImageWarehouse.FD_ImageLoad" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            请你选择图片类型，然后进行上传图片操作。
        <br />
            图片类别:<asp:DropDownList ID="ddlImageType" runat="server"></asp:DropDownList>
            <br />
            <input id="fileInput1" name="fileInput1" type="file" /><br />
                <a href="javascript:if(checkImport()){ $('#fileInput1').uploadifyUpload(); }">开始上传</a>
            <br /> 
