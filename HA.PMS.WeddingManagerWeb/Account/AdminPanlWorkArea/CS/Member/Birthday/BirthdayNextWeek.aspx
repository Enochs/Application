<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" AutoEventWireup="true" CodeBehind="BirthdayNextWeek.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.CS.Member.Birthday.BirthdayNextWeek" %>
                    ...
                    <asp:Repeater ID="repCustomer" runat="server">
                        <ItemTemplate>
                            <tr skey='<%#Eval("CustomerID") %>'>
                                ...
                                <td style="word-break: break-all;"><%#Eval("GroomCellPhone") %></td>
                                ...
                                <td style="word-break: break-all;"><%#ShowShortDate(Eval("GroomBirthday")) %></td>
