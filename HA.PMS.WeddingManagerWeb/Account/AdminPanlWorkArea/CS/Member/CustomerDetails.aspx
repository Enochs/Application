    ...
    <div class="widget-box">
        ...
        <div class="widget-box" style="height: 170px;">
            <table class="table table-bordered table-striped" border="1">
                ...
                <tr>
                    <td><span>首次到店时间:</span><asp:Literal ID="ltlFirstCome" runat="server"></asp:Literal>
                    </td>
                    ...
                    <td><span>预定时间:</span><asp:Literal ID="ltlOrderDate" runat="server"></asp:Literal></td>
                </tr>
                <tr>
                    <td><span>订单确认时间:</span><asp:Literal ID="ltlSureDate" runat="server"></asp:Literal></td>
                    ...
                    <td><span>满意度调查时间:</span><asp:Literal ID="ltlDofDate" runat="server"></asp:Literal></td>
                </tr>
                <tr>
                    <td><span>总满意度:</span><asp:Literal ID="ltlSumDof" runat="server"></asp:Literal></td>
                    <td><span>实际取件时间:</span><asp:Literal ID="ltlTakeDate" runat="server"></asp:Literal></td>
                    <td></td>
                    <td></td>
                </tr>
            </table>
