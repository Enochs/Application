                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <uc1:MyManager runat="server" ID="MyManager" Title="责任人" />
                                    </td>
                ...
                <tbody>
                    <asp:Repeater ID="repCustomer" runat="server">
                        <ItemTemplate>
                            ...
                            <tr <%#Eval("FlowCount").ToString().ToInt32()>=3?"style='color:red;'":"" %>>
                                <td><a target="_blank" href="/AdminPanlWorkArea/CS/Member/CustomerDetails.aspx?Sucess=1&CustomerID=<%#Eval("CustomerID") %>&OnlyView=1"><%#ShowCstmName(Eval("Bride"),Eval("Groom"),Eval("OldB")) %></a></td>
