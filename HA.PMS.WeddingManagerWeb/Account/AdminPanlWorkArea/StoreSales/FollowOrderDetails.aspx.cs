    ...
    public partial class FollowOrderDetails : SystemPage
    {
        ...
        protected void btnSaveMoney_Click(int State)
        {
            ...
            if (State == 204 || State == (int)CustomerStates.SucessOrder)
            {
                ...
                //FL_OrderEarnestMoney ObjInsertModel = new FL_OrderEarnestMoney();
                //if (txtMoney.Text != string.Empty)
                //{
                //    ObjInsertModel.EarnestMoney = txtMoney.Text.ToDecimal();
                //}
                //else
                //{
                //    ObjInsertModel.EarnestMoney = 0;
                //}
                ...
                //ObjInsertModel.OrderID = ObjOrder.OrderID;
                //ObjOrderEarnestMoneyBLL.Insert(ObjInsertModel);
