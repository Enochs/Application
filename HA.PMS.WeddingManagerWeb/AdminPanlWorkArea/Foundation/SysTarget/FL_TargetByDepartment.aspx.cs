            ...
            if (!IsPostBack)
            {
                ...
                if (Request["EmployeeID"] == null)
                {
                    ...
                    if (KeyList.Length > 0)
                    {
                        ...
                        {
                            GetWhere = " and IsActive=1 and Year=" + ddlChooseYear.SelectedItem.Text + " and EmployeeID=" + ddlEmployee1.SelectedValue;
                        }
                        else
                        {
                            GetWhere = " and IsActive=1 and Year= " + ddlChooseYear.SelectedItem.Text;
                        }
