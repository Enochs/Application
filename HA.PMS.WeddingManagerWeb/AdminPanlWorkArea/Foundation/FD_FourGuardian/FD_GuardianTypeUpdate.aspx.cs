...
{
    public partial class FD_GuardianTypeUpdate : SystemPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                HA.PMS.DataAssmblly.FD_GuardianType fD_GuardianType = objGuardianTypeBLL.GetByID(TypeId);
                txtTypeName.Text = fD_GuardianType.TypeName;
            }
        }
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            int result = objGuardianTypeBLL.Update(fD_GuardianType);
            if (result > 0)
            {
