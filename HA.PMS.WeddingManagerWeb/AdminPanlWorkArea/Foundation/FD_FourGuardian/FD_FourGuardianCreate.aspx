<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" AutoEventWireup="true" CodeBehind="FD_FourGuardianCreate.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Foundation.FD_FourGuardian.FD_FourGuardianCreate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#<%=flieUp.ClientID%>').change(function () {
                if ($(this).val() != "") {
                    BtnSave.slideDown();
                }
                else {
        ...
        <div class="widget-content">
            <table class="table table-bordered table-striped">
                <tr>
                    <td>姓名</td>
                    <td>
                        <asp:TextBox ID="txtGuardianName" check="1" tip="专业团队人员姓名" CssClass="{required:true}" runat="server" MaxLength="10"></asp:TextBox>
                ...
                <tr>
                    <td>类型</td>
                    <td>
                        <asp:DropDownList ID="ddlGuardianTypeId" runat="server"></asp:DropDownList></td>
                </tr>
                <tr>
                    <td>等级</td>
                    <td>
                        <asp:DropDownList ID="ddlGuardianLevenId" runat="server"></asp:DropDownList></td>
                </tr>
                <tr>
                    <td>合作时间</td>
                    <td>
                        <asp:TextBox ID="txtStarTime" check="0" tip="不填默认为今天" onclick="WdatePicker();" runat="server" MaxLength="20"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>座机</td>
                </tr>
                ...
                <tr>
                    <td>合作价格</td>
                    <td>
                        <asp:TextBox ID="txtCooperationPrice" check="1" tip="合作价格" runat="server" MaxLength="10"></asp:TextBox>
                        <span style="color: red">*</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr style="display: none;">
                    <td>邮箱</td>
                    <td>
                        <asp:TextBox ID="txtEmail" check="0" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>人员头像</td>
                    <td>
                ...
                <tr>
                    <td>开户银行</td>
                    <td>
                        <asp:TextBox runat="server" ID="txtBankName" MaxLength="200" />
                    </td>
                </tr>
                <tr>
                    <td>账户信息</td>
                ...
                <tr>
                    <td>人员简介</td>
                    <td>
                        <%--<asp:TextBox ID="txtExplain" tip="限200个字符！" check="0" TextMode="MultiLine" Rows="2" Width="300" MaxLength="200" runat="server"></asp:TextBox>--%>
                ...
                <tr>
                    <td>排序</td>
                    <td>
                        <asp:TextBox runat="server" ID="txtSort" ClientIDMode="Static" ToolTip="数值越大,显示就越靠前" /></td>
                </tr>
                <tr>
                    <td>
