<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" AutoEventWireup="true" CodeBehind="FD_InviteReturnStateManager.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Foundation.FD_Content.FD_InviteReturnStateManager" %>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr skey='<%#Eval("ItemKey") %>'>
                                            ...
                                            <td>
                                                ...
                                                <asp:LinkButton ID="LinkButton1" OnClientClick="return ValidateThis(this);" CssClass="btn btn-primary btn-mini" CommandName="Edit" CommandArgument='<%#Eval("InviteStateID") %>' runat="server">保存修改</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
