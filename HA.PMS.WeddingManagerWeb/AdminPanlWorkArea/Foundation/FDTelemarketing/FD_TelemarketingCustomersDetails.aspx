<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="FD_TelemarketingCustomersDetails.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Foundation.FDTelemarketing.FD_TelemarketingCustomersDetails" %>
        ...
        <div class="widget-content">
            <table>
                <tr>
                    ...
                    <%--                    <td>联系人<cc2:ddlReferee Width="85" ID="DdlReferee1" runat="server"></cc2:ddlReferee></td>--%>
                ...
                <tr>
                    <td>时间<asp:DropDownList Width="85" ID="ddltimerType" runat="server">
                        ...
                        <asp:ListItem Value="3">成功预定时间</asp:ListItem>
                    </asp:DropDownList></td>
                    ...
                    <td>邀约类型
                        <cc2:ddlApplyType runat="server" ID="ddlApplyType" /></td>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <asp:Repeater ID="rptTelemarketingManager" runat="server" OnItemDataBound="rptTelemarketingManager_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#GetShortDateString(Eval("QuotedCreateDate")) %></td>
                                <td><a target="_blank" href="/AdminPanlWorkArea/CS/Member/CustomerDetails.aspx?Sucess=1&OnlyView=1&CustomerID=<%#Eval("CustomerID") %>"><%#Eval("ContactMan").ToString().Length > 6 ? Eval("ContactMan").ToString().Substring(0,6) : Eval("ContactMan").ToString() %></a>
                                ...
                                <td><%#GetFinishAmount(Eval("CustomerID")) %></td>
            ...
            汇总统计&nbsp;<asp:Button ID="btnDownLoadReport" runat="server" CssClass="btn btn-primary btn-mini" Text="导出报表" OnClick="btnDownLoadReport_Click" Visible="false" />
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th width="40">客源量</th>
                        <th width="65">邀约成功量</th>
                        <th width="65">客户流失量</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <asp:Literal ID="ltlCurrentLoseCount" runat="server"></asp:Literal>
                            <!--客户流失量-->
                        </td>
                        <td>
