    ...
    <div style="height: 900px; overflow: auto;">
        ...
        <table class="table table-bordered table-striped table-select" style="width: 100%;">
            ...
            <tr>
                ...
                <th>
                    <asp:LinkButton runat="server" ID="lbtnSourceCount" CommandName="SourceCount" Text="客源量" OnClick="lbtnSumReturnMoney_Click" /></th>
                <th>
                    <asp:LinkButton runat="server" ID="lbtnInSourceCount" CommandName="InSourceCount" Text="转化量" OnClick="lbtnSumReturnMoney_Click" /></th>
                <th>
                    <asp:LinkButton runat="server" ID="lbtnInSourceRate" CommandName="InSourceRate" Text="转换率" OnClick="lbtnSumReturnMoney_Click" /></th>
                <th>
            ...
            <asp:Repeater ID="repdataList" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td><a href='/AdminPanlWorkArea/Sys/Customer/CustomerInfoModifyManger.aspx?NeedPopu=1&Type=Look&Category=SourceCount&EmployeeID=<%#Eval("EmployeeID") %>&DateRanger=<%=GetStartToEnd() %>' target="_blank"><%#Eval("SourceCount") %></a></td>
                        <td><a href='/AdminPanlWorkArea/Sys/Customer/CustomerInfoModifyManger.aspx?NeedPopu=1&Type=Look&Category=InSourceCount&EmployeeID=<%#Eval("EmployeeID") %>&DateRanger=<%=GetStartToEnd() %>' target="_blank"><%#Eval("InSourceCount") %></a></td>
                        <td><%#Eval("InSourceRate") %></td>
                        <td><a href='/AdminPanlWorkArea/Sys/Customer/CustomerInfoModifyManger.aspx?NeedPopu=1&Type=Look&Category=ComeOrderCount&EmployeeID=<%#Eval("EmployeeID") %>&DateRanger=<%=GetStartToEnd() %>' target="_blank"><%#Eval("ComeOrderCount") %></a></td>
                        <td><a href='/AdminPanlWorkArea/Sys/Customer/CustomerInfoModifyManger.aspx?NeedPopu=1&Type=Look&Category=NewOrderByMonth&EmployeeID=<%#Eval("EmployeeID") %>&DateRanger=<%=GetStartToEnd() %>' target="_blank"><%#Eval("NewOrderByMonth") %></a></td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label runat="server" ID="lblSourceCount" /></td>
                <td>
                    <asp:Label runat="server" ID="lblInSourceCount" /></td>
                <td>
                    <asp:Label runat="server" ID="lblInSourceRate" /></td>
                <td>
