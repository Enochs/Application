<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImageUpload.ascx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Control.ImageUpload" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("html,body").css({ "width": "550px", "height": "300px" });
        $("#fileInput1").uploadify({
            'uploader': '/Content/FileLoad/uploadify.swf',
            'script': '/ImageService.ashx?QuotedID=<%=Request["QuotedID"]%>&KindID=<%=Request["Kind"]%>',

            'folder': '/Files/ImageWareHouse',
            'queueID': 'fileQueue',
            'auto': false,
            'multi': true,
            "fileExt": "*.bmp;*.gif;*.jpg;*.png;*.jpeg;*.rar;*.7z;*.arc;",//设置可以选择的文件的类型，格式如："*.doc;*.pdf;*.rar" 。 
    ...
    <div class="widget-box">
        <div class="widget-title">
            ...
            <div>
                ...
                <br />
                <span id="result"></span><span style="color: red;">注意：每次上传只能上传10个文件,
