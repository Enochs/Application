<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuotedPriceCount.ascx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Control.CountMananger.QuotedPriceCount" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            series: [{
                name: '订单总金额',
                data: [<%=ViewState["sbOrdrSumMoney"]%>]
            }, {
                name: '已收款',
                data: [<%=ViewState["sbHaveMoney"]%>]
                            }, {
                                name: '应收款',
                                data: [<%=ViewState["sbValidateMoney"]%>]
                            }]
        });
    });
</script>
