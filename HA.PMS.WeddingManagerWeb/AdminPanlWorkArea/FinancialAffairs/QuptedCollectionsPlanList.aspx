    ...
    <div style="overflow-x: auto;">
        <div class="widget-box">
            <table>
                ...
                <tr>
                    <td colspan="2">时间：<asp:DropDownList Width="85" ID="ddltimerType" runat="server">
                    ...
                    <td>状态</td>
                    <td>
                        <asp:DropDownList runat="server" ID="ddlRowLock">
                            <asp:ListItem Text="请选择" Value="0" />
                            <asp:ListItem Text="已确认" Value="1" />
                            <asp:ListItem Text="未确认" Value="2" Selected="True" />
                        </asp:DropDownList>
                    </td>
                    <td>
            ...
            <table class="table table-bordered table-striped table-select">
                ...
                <tbody>
                    <asp:Repeater ID="repCustomer" runat="server" OnItemDataBound="repCustomer_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                <td><a target="_blank" href="/AdminPanlWorkArea/StoreSales/FollowOrderDetails.aspx?CustomerID=<%#Eval("CustomerID") %>&OnlyView=1"><%#Eval("ContactMan").ToString().Length > 8 ? Eval("ContactMan").ToString().Substring(0,6)+"..." : Eval("ContactMan").ToString() %>
                                ...
                                <td>
                                    ...
                                    <a <%#GetLock(Eval("PlanID")).ToString()=="False" ? "" : "style='display:none;'" %> class="btn btn-primary btn-mini" href="QuptedCollectionsPlanFinish.aspx?NeedPopu=1&OrderID=<%#Eval("OrderID") %>&QuotedID=<%#Eval("QuotedID") %>&CustomerID=<%#Eval("CustomerID") %>">确认收款</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
