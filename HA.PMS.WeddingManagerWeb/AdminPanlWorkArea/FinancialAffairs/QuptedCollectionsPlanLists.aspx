                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-mini" href="../QuotedPrice/QuotedCollectionsPlanCreate.aspx?OrderID=<%#Eval("OrderID") %>&QuotedID=<%#Eval("QuotedID") %>&CustomerID=<%#Eval("CustomerID") %>&Type=Loss&NeedPopu=1">退订</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
