                ...
                <div class="panel-group" id="accordion">
                    <h4 class="panel-title">
                        ...
                        <asp:DropDownList ID="ddlCustomersType" runat="server" ClientIDMode="Static">
                            <asp:ListItem Selected="True" Value="1">婚宴</asp:ListItem>
                        ...
                        <div id="Div6" class="panel-collapse collapse in">
                            <div class="panel-body">
                                ...
                                <table style="font-family: sans-serif; width: 100%;" border="1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label runat="server" ID="lblVIp" Text="VIP" Style="color: red; font-weight: bold; font-size: 15px;" /></td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label runat="server" ID="lblApplyType" Text="邀约类型" /></td>
                                        <td>
                                            <cc2:ddlApplyType CssClass="ddlApplyType" ID="ddlApplyType" ClientIDMode="Static" runat="server" Width="120px">
                                            </cc2:ddlApplyType>
                                        </td>
                                    </tr>
