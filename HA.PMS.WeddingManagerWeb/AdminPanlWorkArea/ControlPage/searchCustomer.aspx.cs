...
namespace HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.ControlPage
{
    public partial class searchCustomer : SystemPage
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            ObjParList.Add(txtCustomer.Text.Trim().ToString() != string.Empty, "Bride", txtCustomer.Text.Trim().ToString(), NSqlTypes.AndLike);
            ObjParList.Add(txtCustomer.Text.Trim().ToString() != string.Empty, "Groom", txtCustomer.Text.Trim().ToString(), NSqlTypes.OrsLike);

            ObjParList.Add(txtCelPhone.Text.Trim().ToString() != string.Empty, "BrideCellPhone", txtCelPhone.Text.Trim().ToString(), NSqlTypes.AndLike);
            ObjParList.Add(txtCelPhone.Text.Trim().ToString() != string.Empty, "GroomCellPhone", txtCelPhone.Text.Trim().ToString(), NSqlTypes.OrsLike);
