<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="SedimentationTreeBrowse.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.ControlPage.SedimentationTreeBrowse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="widget-content">
        <div class="row-fluid">
            ...
            <asp:PlaceHolder ID="phContentCategory" Visible="false" runat="server">
                            ...
                            <div class="todo">
                                <table>
                                    <tr>
                                        <td>分类名</td>
                                        <td>
                                            <asp:TextBox ID="txtCategoryName" MaxLength="20" runat="server"></asp:TextBox></td>
                                    </tr>

                                    <tr>
                                        <td colspan="2">
                                            <asp:Button ID="btnCategory" OnClick="btnCategory_Click" runat="server" CssClass="btn btn-success" Text="添加子项" />
                                            &nbsp;
                                            <asp:Button ID="btnCategoryUpdate" OnClick="btnCategoryUpdate_Click" runat="server" CssClass="btn btn-primary" Text="修改名称" />&nbsp;
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="display: none;">
                                            <asp:LinkButton ID="lkbtnDelete" Visible="false" CommandName="Delete" CommandArgument='<%#Eval("FileDetailsId") %>' runat="server" CssClass="btn btn-danger btn-mini">删除</asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
