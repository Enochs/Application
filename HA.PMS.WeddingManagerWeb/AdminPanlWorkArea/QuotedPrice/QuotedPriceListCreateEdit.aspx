...
<%--                URI = "/AdminPanlWorkArea/QuotedPrice/QuotedManager/QuotedPriceChange.aspx?QuotedID=<%=Request["QuotedID"] %>&CustomerID=<%=Request["CustomerID"] %>&OrderID=<%=Request["OrderID"] %>";
    ...
    <script type="text/javascript">
        ...
        function CheckPage() {
            ...
            //else if ($("#btnGetCheck").attr("value") == "提交审核") {
            //    alert("该报价未审核,请提交审核");
            //    return false;
            //} else if ($("#btnGetCheck").val() == "审核中") {
            //    alert("报价单正在审核中");
            //    return false;
            //}
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1">
    ...
    <table border="0" style="width: 1325px; margin-left: 60px; margin-right: 60px;" class="table-select">
        <tr>
            <td style="text-align: left; vertical-align: middle;">
                ...
                <asp:Button ID="btnPrints" runat="server" Text="打印" CssClass="btn btn-primary btn-mini btnSubmit" OnClientClick="return BeginPrint();" />
            </td>
        </tr>
    </table>
    <br />
                    ...
                    <asp:Repeater ID="repdatalist" runat="server" OnItemCommand="repdatalist_ItemCommand">
                        <ItemTemplate>
                            <tr id='CreateEdit<%#Eval("ChangeID")%>' onclick="javascript:SetRowKey('CreateEdit<%#Eval("ChangeID")%>')">
                                ...
                                <td style="word-break: break-all;"><%#Eval("ServiceContent")%>
                                    <div style="display: none;">
    ...
    <table style="margin-left: 60px;">
        ...
        <tr>
            ...
            <td>
                <asp:Label runat="server" ID="lblChecksDescription">审核说明：</asp:Label></td>
            <td>
                <asp:TextBox Style="margin: 0; padding: 0;" ID="txtCheckContent" runat="server" Rows="3" TextMode="MultiLine" CssClass="widthText" Enabled="false" Visible="false"></asp:TextBox></td>
        </tr>
        <tr>
            <td>下次沟通时间：</td>
            <td colspan="5">
        ...
        <tr>
            <td colspan="6">
                <asp:Button ID="btnSaveChange" runat="server" Text="保存" OnClick="btnSaveChange_Click" CssClass="btn btn-success btn-mini" Visible="false" />
                ...
                <asp:Button ID="btnfinish" runat="server" Text="签约派工" OnClick="btnfinish_Click" CssClass="btn btn-success btn-mini btnSubmit" OnClientClick="return CheckPage()" />
                <asp:Button ID="btnPrint" runat="server" Text="打印" CssClass="btn btn-primary btn-mini btnSubmit" OnClientClick="return BeginPrint();" Style="margin: 5px 0px 0px 0px;" />
