...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        ...
        function RadioSelect() {
            var text = $("#<%=rdoNodes.ClientID %>").find("input[type='radio']:checked").next().text();
            if (text == "退款" || text == "退订" || text == "其他") {
                $("#txtNode").show();
            } else {
                $("#txtNode").hide();
            }
        ...
        <div>
            ...
            <table class="table table-bordered table-striped" style="width: 100%;">
                <thead>
                    ...
                    <tr runat="server" id="tr_getMoney">
                        <th width="20%">收款时间</th>
                        <th width="20%">收款金额</th>
                        <th width="20%">付款方式</th>
                        <th width="25%">收款理由</th>
                    ...
                    <tr runat="server" id="tr_LoseMoney" visible="false">
                        <th width="20%">退款时间</th>
                        <th width="20%">退款金额</th>
                        <th width="20%">退款方式</th>
                        <th width="25%">退款理由</th>
                        <th width="25%">上传附件</th>
                        <th runat="server" id="th1">操作</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td style="height: 16px;"><%--<%#GetShortDateString(Eval("CollectionTime"))%>--%>
                                    ...
                                    <asp:TextBox runat="server" ID="txtCollectionTime" Text='<%#GetShortDateString(Eval("CollectionTime")) %>' onclick="WdatePicker();" Visible="false" />
                                ...
                                <td><a target="_blank" href='<%#GetImgPath(Eval("FileUrl")) %>' class="zoom first" title="albatros_niwa_001_big" rel="prettyphoto[gallery]">
                                    <asp:Image ID="img" ImageUrl='<%#Eval("FileUrl") %>' Width="90" Height="90" CssClass="attachment-90x90" runat="server" />
                                </a>
                                </td>
                                <td>
                    ...
                    <tr runat="server" id="tr_modify" style="height: 16px;">
                        <td>
                            <cc1:DateEditTextBox ID="txtTimer" onclick="WdatePicker();" check="1" runat="server" Width="90" ClientIDMode="Static"></cc1:DateEditTextBox>
                        </td>
                        <td>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <%--<asp:Button ID="btnConfrim" runat="server" Text="确定" OnClick="btnConfirm_Click" CssClass="btn btn-success" />--%>
                                    </td>
                                    <td>
