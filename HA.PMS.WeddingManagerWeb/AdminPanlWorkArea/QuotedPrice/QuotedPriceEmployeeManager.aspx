    ...
    <div style="overflow-x: auto;">
        <div class="widget-box">
            ...
            <table class="table table-bordered table-striped table-select">
                ...
                <tbody>
                    <asp:Repeater ID="repCustomer" OnItemDataBound="repCustomer_ItemDataBound" OnItemCommand="repCustomer_ItemCommand" runat="server">
                        <ItemTemplate>
                            <tr skey='QuotedPrice<%#Eval("QuotedID") %>'>
                                <td><%#Eval("OrderCoder") %></td>
                                <td><a target="_blank" href="/AdminPanlWorkArea/StoreSales/FollowOrderDetails.aspx?CustomerID=<%#Eval("CustomerID") %>&OnlyView=1"><%#string.Format("{0}\\{1}",Eval("Bride"),Eval("Groom")).Trim('\\') %></a>
