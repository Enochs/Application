                ...
                <tbody>
                    <asp:Repeater ID="repCustomer" runat="server" OnItemDataBound="repCustomer_ItemDataBound" OnItemCommand="repCustomer_ItemCommand">
                        <ItemTemplate>
                            ...
                            <tr>
                                <td style="height: 16px;"><a target="_blank" href="/AdminPanlWorkArea/CS/Member/CustomerDetails.aspx?CustomerID=<%#Eval("CustomerID") %>&OnlyView=1"><%#ShowCstmName(Eval("Bride"),Eval("Groom"),Eval("OldB")) %></a>
                                ...
                                <td>
                                    <asp:Label runat="server" ID="lblLoseDate" Text='<%#GetShortDateString(Eval("LastFollowDate")) %>' /></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="../Flows/Customer/ReturnVisit/FL_ReturnVisitMessageShow.aspx?CustomerID=<%#Eval("CustomerID") %>" class="btn btn-primary">回访</a>
                                </td>
