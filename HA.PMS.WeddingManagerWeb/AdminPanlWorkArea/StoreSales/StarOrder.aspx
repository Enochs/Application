        ...
        <div class="widget-content">
            <table>
                <tr>
                    ...
                    <td>顾问：<asp:DropDownList ID="ddlEmployee" runat="server"></asp:DropDownList></td>
                    <td>新人姓名:
            ...
            <table class="table table-bordered table-striped">
                <thead>
                    ...
                    <tr>
                        ...
                        <th style="white-space: nowrap;">录入时间</th>
                        <th style="white-space: nowrap;">状态</th>
                        <th style="white-space: nowrap;">酒店</th>
                        <th style="white-space: nowrap;">电销</th>
                        <th style="white-space: nowrap;">到店时间</th>
                        <th style="white-space: nowrap;">顾问</th>
                    </tr>
                </thead>
                <tbody>
                    <asp:Repeater ID="repCustomer" runat="server" OnItemDataBound="repCustomer_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("Channel") %></td>
                                <td><%#Eval("Referee") %></td>
                                <td><a target="_blank" href="/AdminPanlWorkArea/CS/Member/CustomerDetails.aspx?CustomerID=<%#Eval("CustomerID") %>"><%#ShowCstmName(Eval("Bride"),Eval("Groom"),Eval("OldB")) %></a>
                                ...
                                <td><%#Eval("ComeDate","{0:yyyy-MM-dd}") %></td>
