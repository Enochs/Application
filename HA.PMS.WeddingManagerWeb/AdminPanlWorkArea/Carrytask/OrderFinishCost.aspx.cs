...
{
    public partial class OrderFinishCost : SystemPage
    {
        /// <summary>
        /// 用户操作
        /// </summary>
        ...
        public string GetCostAmounts(object Source, object TypeSource)
        {
            ...
            int CustomerID = Source.ToString().ToInt32();
            int OrderID = ObjQuotedPriceBLL.GetByCustomerID(CustomerID).OrderID.ToString().ToInt32();
            ...
            if (Type == 1)                  //人员
            {
                //var DataList = ObjProductForDispatchingBLL.GetByOrderID(OrderID).Where(C => C.ParentCategoryID == 190 || C.ParentCategoryID == 191 || C.ParentCategoryID == 300);
                CostAmount = DataList.Where(C => C.RowType == 4 || C.RowType == 5 || C.RowType == 7).Sum(C => C.ActualSumTotal).ToString().ToDecimal();
            }
            else if (Type == 2)             //物料
            {
                //var DataList = ObjProductForDispatchingBLL.GetByOrderID(OrderID).Where(C => C.ParentCategoryID == 192 || C.ParentCategoryID == 193 || C.ParentCategoryID == 194);
            ...
            {
                //var DataList = ObjProductForDispatchingBLL.GetByOrderID(OrderID).Where(C => C.ParentCategoryID == 196);
