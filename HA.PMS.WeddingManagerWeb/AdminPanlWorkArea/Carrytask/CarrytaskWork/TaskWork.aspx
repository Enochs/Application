        ...
        <thead>
            <tr>
                <th style="text-align: left;" id="<%=Guid.NewGuid().ToString() %>">
                    ...
                    <asp:HiddenField ID="hideSuppID" runat="server" ClientIDMode="Static" Value="-1" />
                ...
                <td runat="server" class="widget-content nopadding" id="paretntSelect" visible="false">工程主管:
                                    ...
                                    <ItemTemplate>
                                        <tr <%#GetByQuoted(Eval("DispatchingID"),Eval("ProductID")).ToString().ToInt32() > 0 ? "style='color:red;font-weight:bold;'" : "" %>>
                                            ...
                                            <td style="width: 50px; white-space: nowrap; text-align: left;" id="Row<%#Guid.NewGuid().ToString() %>">
                                                ...
                                                <asp:TextBox runat="server" ID="txtSuppName" CssClass="txtSuppName" Text='<%#Eval("SupplierName") %>' />
