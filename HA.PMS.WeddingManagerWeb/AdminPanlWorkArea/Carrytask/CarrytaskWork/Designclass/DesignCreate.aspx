...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div runat="server" style="height: 55px;" class="div_PrintOrExport">
        <asp:Button runat="server" ID="btnPrint" CssClass="btn btn-primary" Text="打印设计单" OnClientClick="return preview()" Visible="false" />
    ...
    <div style="overflow: scroll;">
        ...
        <table style="text-align: left;" width="98%">
            ...
            <tr runat="server" id="tr_TextBoxInsert">
                ...
                <td></td>
                <td>
                    <asp:DropDownList ID="ddlSupplierName" Width="90" runat="server"></asp:DropDownList>
                </td>
                <td>自动计算
                </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="width: 105px">
                                <asp:DropDownList runat="server" ID="ddlSupplier" Width="90" SelectedValue='<%#Eval("Supplier") %>' DataSourceID="ObjSupplierSource" DataTextField="Name" DataValueField="SupplierID"></asp:DropDownList>
                            </div>
                        </td>
                        <td>
    ...
    <!--显示设计师当天的其他婚礼-->
    <div class="div_PreShow" runat="server" id="div_Quoted">
        <table class="table table-bordered table-selected">
            ...
            <asp:Repeater runat="server" ID="RepDesign">
                <ItemTemplate>
                    <tr>
                        <td><%#GetCustomerName(Eval("CustomerID")) %></td>
                        <td><%#GetPartyDate(Eval("CustomerID")) %></td>
                        <td><%#Eval("PlanFinishDate","{0:yyyy-MM-dd}") %></td>
                        <td><%#GetEmployeeName(Eval("EmpLoyeeID")) %></td>
                        <td><%#GetEmployeeName(Eval("DesignerEmployee")) %></td>
                </ItemTemplate>
            </asp:Repeater>
        </table>
    </div>
