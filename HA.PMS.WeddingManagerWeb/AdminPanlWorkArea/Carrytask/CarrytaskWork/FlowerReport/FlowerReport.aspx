<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowerReport.aspx.cs" StylesheetTheme="Default" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Carrytask.CarrytaskWork.FlowerReport.FlowerReport" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" %>
    ...
    <div class="div_CreateReport">
        <table style="text-align: center; width: 100%;" border="1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtUnite" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td style="display: none;">
                    <asp:TextBox ID="txtSalePrice" tip="姓名" runat="server" Width="155px" CssClass="NoneEmpty" MaxLength="20" Text="0"></asp:TextBox><span style="color: red">*</span>
                </td>
                <td>
                    <asp:TextBox ID="txtQuantity" runat="server" Width="80px" CssClass="NoneEmpty"></asp:TextBox><span style="color: red">*</span>
                </td>
                <td>自动计算</td>
                <td style="display: none;">
                    <asp:TextBox ID="txtSaleSumPrice" check="1" runat="server" Width="70px" CssClass="NoneEmpty" MaxLength="20" Text="0"></asp:TextBox><span style="color: red">*</span></td>
                <td>
            ...
            <asp:Repeater ID="repFlowerPlanning" runat="server" OnItemCommand="repFlowerPlanning_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtUnite" runat="server" Text='<%#Eval("Unite") %>' Width="80px"></asp:TextBox></td>
                        <td style="display: none;">
                            <asp:TextBox ID="txtSalePrice" runat="server" Text='<%#Eval("SalePrice") %>' Width="80px"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="txtQuantity" runat="server" Text='<%#Eval("Quantity") %>' Width="80px"></asp:TextBox></td>
                        <td>
                            <%#Eval("CostSumPrice") %></td>
                        <td style="display: none;">
                            <asp:TextBox ID="txtSaleSumPrice" runat="server" Text='<%#Eval("SaleSumPrice") %>'></asp:TextBox></td>
                        <td>
                            <%--<a href='FlowerImageList.aspx?FlowerID=<%#Eval("Flowerkey") %>' class="btn btn-primary btn-mini">查看</a>--%>
