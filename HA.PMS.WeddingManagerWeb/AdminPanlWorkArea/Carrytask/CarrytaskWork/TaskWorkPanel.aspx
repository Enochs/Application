...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1">
    ...
    <script type="text/javascript">
        ...
        function Settabs4(ControlID, Uri) {
            URI = "/AdminPanlWorkArea/Carrytask/CarrytaskWork/Designclass/" + Uri + ".aspx?DispatchingID=<%=Request["DispatchingID"]%>&CustomerID=<%=Request["CustomerID"]%>&OrderID=<%=Request["OrderID"]%>&QuotedID=<%=Request["QuotedID"]%>&Type=2&NeedPopu=1";
            $(".HAtab").removeClass("active");
            $(ControlID).addClass("active");
            $("#Iframe1").attr("src", URI);
        }
        ...
        function Settabs7(ControlID, Uri) {

            URI = "/AdminPanlWorkArea/Carrytask/CarrytaskWork/" + Uri + ".aspx?DispatchingID=<%=Request["DispatchingID"]%>&CustomerID=<%=Request["CustomerID"]%>&OrderID=<%=Request["OrderID"]%>&QuotedID=<%=Request["QuotedID"]%>&Type=Look&NeedPopu=1";
            $(".HAtab").removeClass("active");
            $(ControlID).addClass("active");
            $("#Iframe1").attr("src", URI);
        }
        ...
        $(document).ready(function () {
            $("#btnSaveDesigner").click(function () {
    ...
    <div class="look_order">
        <table class="table table-bordered">
            <tr>
                ...
                <%--<td class="widget-content nopadding" id="paretntSelect">工程主管:
                    <input runat="server" id="txtEmpLoyee" class="txtEmpLoyeeName" onclick="ShowPopu(this);" type="text" />
                    <asp:Button runat="server" ID="btnSaveDesigner" ClientIDMode="Static" CssClass="btn btn-primary btn-mini" Text="确定" OnClick="btnSaveDesigner_Click" />
        ...
        <div class="widget-box">
            <div class="widget-title">
                <ul class="nav nav-tabs">
                    ...
                    <li class="HAtab" id="Li4" onclick="Settabs5(this,'OrderCost');"><a data-toggle="tab" href="#111">结算评价</a></li>
                    <li class="HAtab" id="Li3" onclick="Settabs6(this,'AllCarryTaskShow');"><a data-toggle="tab" href="#111">执行清单</a></li>
                    <li class="HAtab" id="Li7" onclick="Settabs7(this,'DispatchingStatement');"><a data-toggle="tab" href="#111">结算表</a></li>
                </ul>
            </div>
