...
{
    public partial class AnniversarybyAll :SystemPage
    {
        ...
        protected void BinderData(object sender,EventArgs e)
        {
           ...
           //新人姓名
            ...
            {
                //一周内
                case 1: query = new Dispatching().GetCsCustomersByPartyDateRangeIgnoreYear(CtrPageIndex.PageSize, CtrPageIndex.CurrentPageIndex, out SourceCount, User.Identity.Name.ToInt32(), paramList, Monday, Sunday); break;
                //下周
                case 2: query = new Dispatching().GetCsCustomersByPartyDateRangeIgnoreYear(CtrPageIndex.PageSize, CtrPageIndex.CurrentPageIndex, out SourceCount, User.Identity.Name.ToInt32(), paramList, NextMonday, NextSunday); break;
                //所有
