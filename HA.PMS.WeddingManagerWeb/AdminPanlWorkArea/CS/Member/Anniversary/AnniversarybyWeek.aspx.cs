...
{
    public partial class AnniversarybyWeek : SystemPage
    {
        ...
        protected void BinderData(object sender, EventArgs e)
        {
            ...
            var query = new Dispatching().GetCsCustomersByPartyDateRangeIgnoreYear(CtrPageIndex.PageSize, CtrPageIndex.CurrentPageIndex, out SourceCount, User.Identity.Name.ToInt32(), paramList, Monday, Sunday);
