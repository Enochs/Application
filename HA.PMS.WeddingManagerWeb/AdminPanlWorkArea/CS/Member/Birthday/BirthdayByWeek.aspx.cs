...
{
    public partial class BirthdayByWeek : SystemPage
    {
        ...
        protected void BinderData(object sender, EventArgs e)
        {
            ...
            var query = new Dispatching().GetCsCustomersByBirthdayRange(CtrPageIndex.PageSize, CtrPageIndex.CurrentPageIndex, out SourceCount, User.Identity.Name.ToInt32(), paramList, Monday, Sunday);
