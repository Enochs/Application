...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1">
    ...
    <br />
    <span style="font-size: 15px; color: brown; font-weight: bolder;">基础设置</span>
    <table class="table table-bordered table-striped table-select">
        <thead>
            ...
            <tr>
                ...
                <th style="white-space: nowrap; float: left;">当前状态</th>
            ...
            <asp:Repeater ID="repSysConfig" runat="server" OnItemCommand="repSysConfig_ItemCommand">
                <ItemTemplate>
                    <tr skey='<%#Eval("ConFigID") %>'>
                        ...
                        <td style="float: left;"><%#GetState(Eval("IsClose")) %></td>
                        <td>
    ...
    <br />
    <span style="font-size: 15px; color: brown; font-weight: bolder;">特殊设置</span>
    <table class="table table-bordered table-striped table-select">
        <thead>
            <tr style="border: none;">
                <td style="border: none;" colspan="3">
            ...
            <tr>
                <th style="white-space: nowrap;">配置函数</th>
                <th style="white-space: nowrap;">说明</th>
                <th style="white-space: nowrap; float: left;">选择</th>
                <th style="white-space: nowrap;">操作</th>
            </tr>
        </thead>
        <tbody>
            <asp:Repeater ID="RepSysConfigs" runat="server" OnItemCommand="RepSysConfigs_ItemCommand" OnItemDataBound="RepSysConfigs_ItemDataBound">
                <ItemTemplate>
                    <tr skey='<%#Eval("ConFigID") %>'>
                        <asp:HiddenField ID="HideConfigID" ClientIDMode="Static" Value='<%#Eval("ConfigID") %>' runat="server" />
                        <td>
                            <%#Eval("ConfigName") %>  
                        </td>
                        <td><%#Eval("ConfigMarke") %></td>
                        <td  id="Partd<%#Container.ItemIndex %>">
                            <asp:TextBox runat="server" ID="txtEmpLoyee" CssClass="txtEmpLoyeeName" onclick="ShowPopu(this);" />
                            <asp:HiddenField ID="hideEmpLoyeeID" ClientIDMode="Static" Value='' runat="server" />
                        </td>
                        <td>
                            <asp:Button runat="server" ID="btnSave" Text="保存" CssClass="btn btn-primary btn-mini" />
                        </td>
