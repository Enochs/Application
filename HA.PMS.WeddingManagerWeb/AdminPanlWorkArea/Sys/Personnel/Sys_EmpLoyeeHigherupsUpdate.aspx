<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" AutoEventWireup="true" CodeBehind="Sys_EmpLoyeeHigherupsUpdate.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Sys.Personnel.Sys_EmpLoyeeHigherupsUpdate" %>
        ...
        <div class="widget-content">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <td>Code:</td>
                    <td>
                        <asp:TextBox ID="txtCode" check="1" tip="限20个字符！" CssClass="{required:true}" runat="server" MaxLength="100"></asp:TextBox>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
