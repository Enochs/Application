        ...
        <div class="widget-content">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <td>紧急联系人</td>
                    <td>
                        <asp:TextBox Style="margin: 0" ID="txtEmergencyContact" check="0" tip="紧急联系人姓名" runat="server" MaxLength="50"></asp:TextBox>
                        <span style="color: red">*</span>
                    </td>
                </tr>
                <tr>
                    <td>联系人电话</td>
                    <td>
                        <asp:TextBox Style="margin: 0" ID="txtEmergencyPhone" check="0" tip="紧急联系人电话" runat="server" MaxLength="50"></asp:TextBox>
                        <span style="color: red">*</span>
                    </td>
                </tr>
                <tr>
                    <td>联系人关系</td>
                    <td>
                        <asp:TextBox Style="margin: 0" ID="txtEmergencyShip" check="0" tip="紧急联系人关系" runat="server" MaxLength="50"></asp:TextBox>
                        <span style="color: red">*</span>
                    </td>
                </tr>
                <tr>
