    ...
    <div style="height: 950px; overflow: auto;">
        <table style="font-family: sans-serif; width: 100%;" border="1" class="table table-bordered table-striped">
            <tr>
                ...
                <td style="text-align: left">
                    <asp:Label ID="lblCreateEmployee" runat="server" Text="Label"></asp:Label>
                    &nbsp;&nbsp;</td>
                <td style="text-align: right">录入日期</td>
                <td style="text-align: left">
                    <asp:Label ID="lblCreateDate" runat="server" Text="Label" Visible="false"></asp:Label>
                    <asp:TextBox runat="server" ID="txtCreateDate" onclick="WdatePicker();" />
        ...
        <table class="table table-bordered" border="0" style="width: 100%;" cellpadding="10" cellspacing="10">
            <tr>
            ...
            <tr>
                <td colspan="10">
                    ...
                    <table class="table table-bordered" style="width: 100%;">
                        <tr>
                            <td>渠道类型</td>
                            <td style="text-align: left" cellpadding="10" cellspacing="10">
                            ...
                            <td style="text-align: left">
                                <asp:DropDownList ID="ddlCustomersType" runat="server" ClientIDMode="Static">
                                    <asp:ListItem Value="1">婚宴</asp:ListItem>
                                    <asp:ListItem Value="2">生日宴</asp:ListItem>
                                    <asp:ListItem Value="3">庆典</asp:ListItem>
                        ...
                        <tr>
                            <td>
                                <img src="../../../Images/vips.jpg" alt="VIP(会员)" />

                            </td>
                            <td>
                                <asp:RadioButtonList runat="server" ID="rdoIsVIP" RepeatDirection="Horizontal" Width="120px" CellPadding="20" CellSpacing="20">
                            ...
                            <td>邀约类型</td>
                            <td style="text-align: left;">
                                <cc2:ddlApplyType ID="ddlApplyType" runat="server">
                                </cc2:ddlApplyType></td>
                        </tr>
                    </table>
                </td>
