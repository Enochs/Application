...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="widget-box">
        ...
        <table runat="server" id="tblLook" style="margin-top: 10px; margin-left: 15px;">
            <tr>
                <td>
                ...
                <td>酒店：<cc2:ddlHotel ID="ddlHotel" runat="server" Width="100px"></cc2:ddlHotel>
                    <asp:TextBox runat="server" ID="txtHotel" />
                </td>
            </tr>
            <tr>
                <td>新人状态<cc2:ddlCustomersState runat="server" ID="ddlCustomersState1" Width="120px"></cc2:ddlCustomersState></td>
                <td>
