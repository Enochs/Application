<%@ Page Title="" Language="C#" StylesheetTheme="Default" MasterPageFile="~/AdminPanlWorkArea/Master/PopuMaster.Master" AutoEventWireup="true" CodeBehind="CompanyOperationSystem.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Company.CompanyOperationSystem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowWindows(KeyID, Control, Type) {
            var Url = "CompanySystemUpdate.aspx?SystemId=" + KeyID + "&Type=" + Type + "&SystemType=3";
        ...
        function ShowFileUploadPopu(SystemID, SystemTitle) {
            var Url = "/AdminPanlWorkArea/Company/CompanySystemUpLoad.aspx?SystemID=" + SystemID + "&SystemTitle=" + SystemTitle + "&FileType=3"; //1.公司制度 2.销售部制度  3.运营部制度
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:PlaceHolder ID="phContent" runat="server">
        ...
        <p></p>
        <a class="btn btn-danger" runat="server" clientidmode="Static" href="CompanySystemCreate.aspx?FileType=3" id="createKnow">新建制度</a>&nbsp;&nbsp;
