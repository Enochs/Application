...
{
    public partial class ComplainAdminPanel : SystemPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //var allCustomers = objComplainBLL.GetbyParameter(new ObjectParameter[] { }).Where(C => C.ComplainEmployeeId == employeeId).ToList();
