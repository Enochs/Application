<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="CommandByCustomerAdminPanel.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Commandanddispatch.CommandByCustomerAdminPanel" %>
        ...
        <div class="widget-box">
            <div class="widget-title">
                <ul class="nav nav-tabs">
                    ...
                    <li class="HAtab" style="display: none;"><a data-toggle="tab" href="#111" onclick="Settabs(this,'/AdminPanlWorkArea/Commandanddispatch/CommandByPlanEmployeeManager.aspx?NeedPopu=1');">下属指标动态</a></li>
                    ...
                    <li class="HAtab" onclick="Settabs(this,'/AdminPanlWorkArea/CS/CS_DegreeOfSatisfactionAll.aspx?NeedPopu=1');"><a data-toggle="tab" href="#111">满意度明细</a></li>
                    <li class="HAtab" onclick="Settabs(this,'/AdminPanlWorkArea/CS/CS_ComplainManagerAll.aspx?NeedPopu=1');"><a data-toggle="tab" href="#111">投诉明细</a></li>
                    <li class="HAtab" onclick="Settabs(this,'/AdminPanlWorkArea/Flows/Customer/ReturnVisit/FL_CustomerReturnVisitManager.aspx?NeedPopu=1');"><a data-toggle="tab" href="#111">回访明细</a></li>
