<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanlWorkArea/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="CommandByInviteAdminPanel.aspx.cs" Inherits="HA.PMS.WeddingManagerWeb.AdminPanlWorkArea.Commandanddispatch.CommandByInviteAdminPanel" %>
        ...
        <div class="widget-box">
            <div class="widget-title">
                <ul class="nav nav-tabs">
                    ...
                    <li class="HAtab"  style="display:none;"><a data-toggle="tab" href="#111" onclick="Settabs('#tab3',3,'/AdminPanlWorkArea/Commandanddispatch/CommandByInviteEmployeeManager.aspx?NeedPopu=1');">下属指标动态</a></li>
                    ...
                    <li class="HAtab"  onclick="Settabs(this,'/AdminPanlWorkArea/Invite/Customer/InviteList.aspx?NeedPopu=1');"><a data-toggle="tab" href="#111">新人明细</a></li>
                    <li style="display:none;"><a data-toggle="tab" href="#111" >邀约分派</a></li>
 
                </ul>
            </div>
            <div class="widget-content tab-content">
                <div class="tab-pane active" id="tab1">
                    <iframe class="framchild " id="Iframe1" name="main" scrolling="no" noresize width="100%" height="1900px" frameborder="0" name="table" src="/AdminPanlWorkArea/Commandanddispatch/GeneralManagerPodium/WorkCheckGuide.aspx?NeedPopu=1"></iframe>
                </div>
