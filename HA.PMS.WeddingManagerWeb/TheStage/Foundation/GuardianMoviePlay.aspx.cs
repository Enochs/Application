    ...
    public partial class GuardianMoviePlay : SystemPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ViewState["MoviePath2"] = GetImgPath2(movie.MoviePath);
        ...
        /// <returns></returns>
        protected string GetMovieExtension(string moviePath) 
        {
            //ViewState["MoviePath"]
            string ext = Path.GetExtension(GetImgPath(moviePath));
            return ext;
        ...
        /// </summary>
        /// <returns></returns>
        protected string GetImgPath2(object source)
        {
            string sourcePath = (source + string.Empty);
            return Request.ServerVariables["HTTP_HOST"] + sourcePath.Replace("~", "");
