...
namespace HHLWedding.BLLAssmbly
{
    public class BaseService<T> : IBase<T> where T : class
    {
        ...
        /// <returns></returns>
        public List<T> GetPagedList<TKey>(int pageIndex, int pageSize, ref int rowCount, List<Expression<Func<T, bool>>> parmList, Expression<Func<T, TKey>> orderByLambda, bool isAsc = true)
        {
        ...
        /// <param name="orderBy">排序 lambda表达式</param>
        /// <returns></returns>
        public List<T> GetPagedList<TKey1, TKey2>(int pageIndex, int pageSize, ref int rowCount, List<Expression<Func<T, bool>>> parmList, Expression<Func<T, TKey1>> orderByLambda1, Expression<Func<T, TKey2>> orderByLambda2, bool isAsc1 = true, bool isAsc2 = true)
        {
            IQueryable<T> query = ObjEntity.Set<T>();
            if (parmList != null)
            {
        ...
        /// <param name="orderBy">排序 lambda表达式</param>
        /// <returns></returns>
        public List<T> GetListByPageer<TKey>(IQueryable<T> query, int pageIndex, int pageSize, ref int rowCount, List<Expression<Func<T, bool>>> parmList, Expression<Func<T, TKey>> orderByLambda, bool isAsc = true)
        {
