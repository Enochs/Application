...
namespace HA.PMS.DataAssmblly
{
    ...
    public partial class FL_MissionDetailed
    {
        public FL_MissionDetailed()
        {
            this.FL_MissionFile = new HashSet<FL_MissionFile>();
        }
        ...
        public virtual ICollection<FL_MissionFile> FL_MissionFile { get; set; }
    }
}
